...
const validationSchema = Yup.object({
  ...
  hasOtherIncome: Yup.string().required(
    "Please indicate if you have any other income."
  ),
});
          ...
          {({ isSubmitting }) => (
            <Form>
              <h2 className="text-3xl font-medium mb-10">
                ...
                ,please tell us your income details
              </h2>
              {/* Total annual income field */}
              <div className="mb-4">
                <label
                  htmlFor="totalAnnualIncome"
                  className="block text-gray-900 text-sm font-bold mb-2"
                >
                  What is your total annual income?
                </label>
                <p className="pb-2 text-gray-700">
                  Include all your income if you have more than one
                </p>
                <Field
                ...
                {isExpanded && (
                  <div className="mt-2">
                    ...
                    <ul className="list-disc list-inside">
                      <li>
                        Employed, gross income before taxes and deductions
                      </li>
                      <li>
                        Sole trader or partnerships, net profits (average of
                        last 2 years or latest year, whichever is smaller)
                      </li>
                      <li>
                        Ltd Company Directors, salary and net profits after
                        corporation tax (average of last 2 years total or latest
